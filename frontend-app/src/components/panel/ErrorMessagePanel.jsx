...
export const ErrorMessagePanel = ({ className, message }) => {
  return (
    <PanelContainer className={className}>
      <div className="flex flex-col items-center px-2 py-8">
        <svg
          ...
          className="h-24 w-24 block mb-2"
          aria-hidden="true"
          role="img"
        ...
        >
          ...
          ></path>
          <path fill="#5DADEC" d="M10 30c0 2.762-2.238 5-5 5s-5-2.238-5-5s4-10 5-10s5 7.238 5 10z"></path>
          <path
            fill="#664500"
        ...
        <p className="text-gray-300 font-bold text-xl mb-2">出错了</p>
