...
const EVENT_BUFFERED_AMOUNT_LOW = 'buffered-amount-low';
const EVENT_TRANSMISSION_PROGRESS = 'transmission-progress';
const EVENT_TRANSMISSION_PAUSED = 'transmission-paused';
const EVENT_TRANSMISSION_COMPLETED = 'transmission-completed';
const EVENT_TRANSMISSION_SPEED_UPDATE = 'transmission-speed-update';
